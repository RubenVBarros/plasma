...
let tailleRef = 3779; //Variable générale qui donne l'effet de zoom
let rayon = 1500;//Vitesse de déplacement des objets
let centreX = 700;//Position horizontale du point de fuite

//Image de l'arrière plan de l'application
